...
namespace HyperionScreenCap
{
  class Settings
  {
    ...
    public static Form1.NotifcationLevels NotificationLevel;
    ...
    public static void LoadSetttings()
    {
      if (Config.HasFile)
      {
        ...
        NotificationLevel =
          (Form1.NotifcationLevels) Enum.Parse(typeof(Form1.NotifcationLevels), setting["notificationLevel"].Value);
      }
    }
  }
}
