...
public struct Register : IFlatbufferObject
{
  ...
  public static Offset<hyperionnet.Register> CreateRegister(FlatBufferBuilder builder,
  ...
  public static Offset<hyperionnet.Register> EndRegister(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    builder.Required(o, 4);  // origin
    return new Offset<hyperionnet.Register>(o);
  }
  public RegisterT UnPack() {
    var _o = new RegisterT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(RegisterT _o) {
    _o.Origin = this.Origin;
    _o.Priority = this.Priority;
  }
  public static Offset<hyperionnet.Register> Pack(FlatBufferBuilder builder, RegisterT _o) {
    if (_o == null) return default(Offset<hyperionnet.Register>);
